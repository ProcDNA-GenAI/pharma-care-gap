    ...
    <Card padding="sm">
      <div className="flex items-center justify-between gap-2 mb-3">
        <div className="flex items-center gap-2">
          ...
          <span className="shrink-0 text-[10px] font-bold text-[#004FBA] bg-[#004FBA]/10 px-1.5 py-0.5 rounded">M3</span>
          <h2 className="text-sm font-semibold text-gray-900">High-Dose/Prolonged OCS Exposure Rate</h2>
        </div>
        <span className="shrink-0 text-[10px] font-medium text-gray-400 bg-gray-100 px-2 py-0.5 rounded-full">Exclusion Criteria</span>
      </div>
