    ...
    <Card padding="sm">
      <div className="flex items-center justify-between gap-2 mb-3">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-sm font-semibold text-gray-900">Composite OCS Overuse Eligibility</h2>
        </div>
      ...
      <div className="mt-3 rounded-lg border border-gray-200 bg-gray-50 px-3 py-2.5">
        <p className="text-[10px] font-semibold text-gray-500 uppercase tracking-wide mb-1">Care Gap Metric Type</p>
